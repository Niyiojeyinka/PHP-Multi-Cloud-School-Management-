    ...
    */
    ...
    public function __construct()
    {
      ...
      $this->load->helper(array('url','form','page_helper','result_helper'));
        ...
        if (isset($_SESSION['student_id']) && (!empty($this->uri->segment(2))) &&($_SESSION['student_id'] != $this->uri->segment(2))){
...
$data['school'] = $this->schools_model->get_school_by_id($data['student']['school_id']);
       ...
       $this->load->view('common/head_meta_view',$data); 
        ...
        $this->load->view('public/scan_id_student_view',$data); 



    }
public function pay_fees($student_id)
{
 ...
 //divisional
  ...
  $data['paid_fees'] =  $this->parents_model->get_sessional_paid_fees($session,$data['school']['id'],$data['child']);
       ...
       $this->load->view('common/head_meta_view',$data); 
        ...
        $this->load->view('public/pay_fees_view',$data); 
...
//insert PRe_pay payment
    ...
    $this->parents_model->insert_prepay_payment($pre_payment);
       ...
       $this->load->view('common/head_meta_view',$data); 
        ...
        $this->load->view('public/pre_payment_gateway_view',$data); 
  ...
  show_page('Idcard/pay_fees/'.$child_id);
}
...
$this->session->mark_as_flash('action_status_report');
//show_page("Idcard/manage_fees/".$hold_ref);
show_page("Idcard/pay_fees/".$student_id);
...
public function check_pay_fees($student_id)
{
 ...
 //divisional
  ...
  $data['paid_fees'] =  $this->parents_model->get_sessional_paid_fees($session,$data['school']['id'],$data['child']);
       ...
       $this->load->view('common/head_meta_view',$data); 
        ...
        $this->load->view('public/confirm_payments_view',$data); 
