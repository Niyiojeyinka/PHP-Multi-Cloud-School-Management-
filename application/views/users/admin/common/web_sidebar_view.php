...
echo site_url('dashboard/edit_details');
...
<a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/add_media/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa fa-plus
         w3-large w3-center"></i>Add media</a>

         <a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/manage_media/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa-edit
...
if(in_array("news_support",$options))
{
...
<a class="w3-bar-item  rep w3-text-white w3-small" href="#">  <i  style="margin-right:3%" class="fa fa-bullhorn
    ...
    <div class="w3-dropdown-content w3-bar-block">
<a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/add_news/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa-bullhorn
         w3-large w3-center"></i>Post News</a>

         <a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/manage_news/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa-edit
...
if(in_array("event_support",$options))
{
...
<a class="w3-bar-item  rep w3-text-white w3-small" href="#">  <i  style="margin-right:3%" class="fa fa-calendar-check-o
    ...
    <div class="w3-dropdown-content w3-bar-block">
<a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/add_event/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa-calendar-plus-o
         w3-large w3-center"></i>Post Event</a>

         <a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/manage_events/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa-edit
...
if(in_array("slider_support",$options))
{
...
<a class="w3-bar-item  rep w3-text-white w3-small" href="#">  <i  style="margin-right:3%" class="fa fa-camera-retro
    ...
    <div class="w3-dropdown-content w3-bar-block">
<a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/add_slider/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa-camera-retro
         w3-large w3-center"></i>Add Image</a>

         <a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/manage_sliders/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa-camera
...
if(in_array("page_support",$options))
{
...
<a class="w3-bar-item  rep w3-text-white w3-small" href="#">  <i  style="margin-right:3%" class="fa fa fa-bookmark
    ...
    <div class="w3-dropdown-content w3-bar-block">
<a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/add_page/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa fa-bookmark
         w3-large w3-center"></i>Add Page</a>

         <a class="w3-bar-item  rep w3-small" href="'.site_url('webfunction/manage_pages/'.$this->uri->segment(3)).'">  <i  style="margin-right:3%" class="fa fa-edit
...
if(in_array("favicon_support",$options))
{


   echo "<a class='w3-bar-item  rep w3-text-white w3-small' href='".site_url('webfunction/change_favicon/'.$this->uri->segment(3))."'>  <i  style='margin-right:3%' class='fa fa-image
         w3-large w3-text-white w3-center'></i>Change Favicon</a>";
   
}

/*
if(in_array("notice_support",$options))
{


   echo    "<a class='w3-bar-item  rep w3-text-white w3-small' href='".site_url('dashboard/logout')."'>  <i  style='margin-right:3%' class='fa fa-bell
...
if(in_array("slider_support",$options))
{
   ...
   echo    "<a class='w3-bar-item  rep w3-text-white w3-small' href='".site_url('dashboard/logout')."'>  <i  style='margin-right:3%' class='fa fa-image
         w3-large w3-text-white w3-center'></i>Sliders</a>";

}
*/
if(in_array("result_support",$options))
{


   echo    "<a class='w3-bar-item  rep w3-text-white w3-small' href='".site_url('resultmanager/index')."'>  <i  style='margin-right:3%' class='fa fa-graduation-cap
...
echo '<a class="w3-bar-item  rep w3-text-white w3-small" href="'.site_url('prewebsettings_action/theme_settings/'.$this->uri->segment(3).'/'.$theme_options[$i][2]).'"><i  style="margin-right:3%" class="fa '.$theme_options[$i][0].' w3-large w3-text-white w3-center"></i>'.ucfirst($theme_options[$i][1]).'</a>';
