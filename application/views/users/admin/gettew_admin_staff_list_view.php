...
<span class="w3-text-theme w3-large w3-margin"><?=ucfirst($item['firstname']." ".$item['lastname']) ?></span><br>
<span><?=ucfirst($item['staff_type']) ?> Staff</span>
<br>
</div></a>
