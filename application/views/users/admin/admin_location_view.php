...
<div class="w3-container w3-center">
  ...
  <hr>
	...
	<select id="country_s" name="country_s" class="w3-padding w3-margin">
		
	</select>
<br>
	<span class="w3-label">State/Province:</span><br>

	<select  id="state_s" name="state_s" class="w3-padding w3-margin">
		
	</select>
<br>
<input type="submit" class="w3-button w3-theme w3-margin" name="submit">
