...
echo $item['title'];
echo "</span><br>";
echo  "<a href='".site_url('webfunction/page_preview/'.$item['slug'])."' ><span class='fa fa-eye w3-text-theme w3-margin-right'></span></a> <a href='".site_url('webfunction/confirm_delete/'.$this->uri->segment(3).'/page/'.$item['slug'])."' ><span class='fa fa-trash w3-text-theme w3-margin-right'></span></a>  <a href='".site_url('webfunction/edit_page/'.$this->uri->segment(3).'/'.$item['slug'])."' ><span class='fa fa-pencil w3-text-theme'></span></a> ";
