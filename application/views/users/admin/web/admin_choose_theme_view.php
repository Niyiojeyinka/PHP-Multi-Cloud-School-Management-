...
<!--
<?php
echo form_open('gettew_prewebsettings/search_themes/'.$this->uri->segment(3));
...
echo '<a href="'.site_url('gettew_prewebsettings_action/theme_details/'.$theme['name']."/".$this->uri->segment(3)).'" class="w3-button w3-white w3-border w3-margin">View Details<a>
';
//echo '<a href="'.site_url('gettew_webdemo/theme_demo/').'" class="w3-button w3-white w3-border w3-margin">Demo<a>';
