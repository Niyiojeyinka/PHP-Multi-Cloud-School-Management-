...
<b class="w3-xlarge w3-text-theme">Add Media</b><br>

<?php

echo form_open_multipart('gettew_webfunction/add_Media/'.$this->uri->segment(3));
...
<br>
<input type="submit" class="w3-button w3-large w3-teal w3-hover-white w3-hover-text-teal w3-border w3-border-teal w3-round-large w3-margin" value="Save Media" name="submit"></input><br>
