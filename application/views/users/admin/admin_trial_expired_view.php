...
<span class="w3-text-red w3-large">TRIAL EXPIRED</span>
	<br>
	<div style="max-width: 80%;" class="w3-text-teal w3-padding-jumbo"><strong>Hey,Your Account TRIAL Software Access and Sub-Domain has Expired on <?=date("F j Y,g:ia",$school['license_expire']) ?> </strong><br>
		<span>Your Website will not be accessible until successful upgrade</span>
<br>
