...
<script type="text/javascript" src="<?php echo base_url('assets/dist/summernote.js'); ?>">
    ...
    <div class="">
<b class="w3-xlarge w3-text-theme">Add Article</b><br>

<?php

echo form_open_multipart('staff/add_new_article');
...
<textarea id="contents" placeholder="Article contents" class="w3-center w3-border-blue-grey" name="contents"  value="<?php  echo set_value('contents'); ?>"></textarea><br>
